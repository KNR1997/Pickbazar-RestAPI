...
from users.selectors import user_get, user_list, profile_get_by_user, customer_list, vendor_list
...
class VendorListApi(APIView):
    ...
    def get(self, request):
        ...
        vendors = vendor_list(filters=filters_serializer.validated_data)
